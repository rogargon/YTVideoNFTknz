...
describe('YTAPIConsumer Tests', async function () {
    ...
    it('Should get a positive verification for a valid video', (done) => {
        ...
        let onOracleRequest = mockOracle.once('OracleRequest',
        ...
        let onVerificationRequest = apiConsumer.once('VerificationRequest', (requestId, videoId, videoTokenId) =>
            console.log('VerificationRequest:', requestId, videoId, videoTokenId))
        let onYouTubeVideoVerification = apiConsumer.once('YouTubeVideoVerification', async(requestId, videoId, isVerified) => {
